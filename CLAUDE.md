...
- 단계: **v1.0 (MVP1 완료).** 로컬 기록·예측·인사이트 + Supabase 인증·클라우드 동기화 + 다이어리·매거진 출시. 다음: 백그라운드 sync / 충돌 해결 / 다기기 검증 (README.ko.md 로드맵 참고).
...
**MVP1 (v1.0)** 1. 생리 시작/종료 기록 2. 평균 주기 기반 예측 3. 오늘의 컨디션 기록 4. 다이어리 캘린더(일정·스티커·공휴일) 5. rule-based 인사이트 6. Supabase 인증 7. 클라우드 동기화 8. 매거진(아티클·북마크·체형 진단)
