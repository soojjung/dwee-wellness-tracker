...
- Auth: login gate on cold start, age/terms consent gate before any sign-in path (STEP 1.5), anonymous + Apple/Google OAuth, anonymous→account migration, 6-store rehydrate on mode switch.
