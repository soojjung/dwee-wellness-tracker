...
export function PrivacyScreen() {
  ...
  return (
    <LegalArticleLayout title={t.myPage.support.privacy}>
      ...
      <p className="mt-1 text-xs leading-5 text-brand-gray600">{PRIVACY_KO.effectiveDate}</p>
      <p className="mt-4 text-[13px] leading-[1.7] text-brand-gray700">{PRIVACY_KO.intro}</p>
